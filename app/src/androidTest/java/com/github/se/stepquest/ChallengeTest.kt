...
class ChallengeTest {
  @Test fun testCompletionFunctions() {
    var challenge = createChallengeItem("testUserId", "testUserName", "testUserId", "testUserName", ChallengeType.REGULAR_STEP_CHALLENGE)
    var result = ChallengeType.REGULAR_STEP_CHALLENGE.completionFunction(challenge)
    assertEquals(false, result)
    challenge = createChallengeItem("testUserId", "testUserName", "testUserId", "testUserName", ChallengeType.DAILY_STEP_CHALLENGE)
