            ...
            if (clickedMarker.title == "Route") {
                ...
                route?.let { it ->
                    ...
                    checkpoints?.forEach { checkpoint ->
                        googleMap.addMarker(
                            MarkerOptions()
                                .position(LatLng(checkpoint.location.latitude, checkpoint.location.longitude))
                ...
                checkpoint?.let {
                    AlertDialog.Builder(context).apply {
                        ...
                        // If you have an image and want to display it, consider using a custom layout or fetching the image asynchronously
                    }.create().show()
                }
            }
